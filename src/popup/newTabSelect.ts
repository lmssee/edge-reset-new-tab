...
import { CSStorage, newTabValueT } from '../common/chromeSStorage';
...
export const manageNewTabSelect: {
  ...
  init() {
    ...
    popupData.observe(
      'newTabValue',
      (property?: string, newValue?: unknown) => {
        // 根据值设置当前的
